 ...
 */
function initializeCommandInterface(): readline.Interface | null {
 ...
 * Graceful shutdown
 */
async function shutdown(rl: readline.Interface | null): Promise<void> {
...
const main = async (): Promise<void> => {
  ...
  try {
    ...
    // Start server
    server = app.listen(port:PORT,hostname:'0.0.0.0', () => {
